...
class PricePlanController {
   ...
   public function __construct(Request $request, PricePlanService $pricePlanService, FileService $fileService,
   ...
   public function create(array $data){
      ...
      $rentalObjectService = new RentalObjectService($rentalObjectMapper, $this->pricePlanService, $this->fileService);
